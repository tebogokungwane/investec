...
public class Address {
    ...
    public Address(String s, Type type, AddressLineDetail addressLineDetail, ProvinceOrState provinceOrState, String s1, Country country, String number, String s2) {
    }
